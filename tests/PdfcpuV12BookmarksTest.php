...
class PdfcpuV12BookmarksTest extends TestCase
{
    public function testImportBookmarksException()
    {
        ...
        $pdfcpu = new PdfcpuV12Wrapper($binary, $mockProcessFactory);
    ...
    public function testApplyBookmarksException()
    {
        ...
        $regex = sprintf(
            "|^'%s' bookmarks import --replace '%s' '[a-zA-Z0-9/]+\.json' '%s'$|",
            $binary,
            $pdf,
            $outfile
        );
    ...
    public function testApplyBookmarksRealPdf()
    {
        ...
        $wrapper = new PdfcpuV12Wrapper($binary);
